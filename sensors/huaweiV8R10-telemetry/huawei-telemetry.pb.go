...
type Telemetry struct {
	...
	Encoding             Telemetry_Encoding `protobuf:"varint,12,opt,name=encoding,proto3,enum=huaweiV8R10_telemetry.Telemetry_Encoding" json:"encoding,omitempty"`
...
type TelemetrySelfDefinedEvent struct {
	...
	ThresholdRelation    TelemetrySelfDefinedEvent_ThresholdRelation `protobuf:"varint,7,opt,name=thresholdRelation,proto3,enum=huaweiV8R10_telemetry.TelemetrySelfDefinedEvent_ThresholdRelation" json:"thresholdRelation,omitempty"`
...
type TelemetryThreshold struct {
	...
	ThresholdOpType      TelemetryThreshold_ThresholdOpType `protobuf:"varint,2,opt,name=thresholdOpType,proto3,enum=huaweiV8R10_telemetry.TelemetryThreshold_ThresholdOpType" json:"thresholdOpType,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}
